...
@testitem "MIMO - ChandeKrollStop" begin
    ...
    ind = ChandeKrollStop(atr_period = 5, atr_mult = 2.0, period = 3)
...
@testitem "MIMO - SFX" begin
    ...
    ind = SFX(atr_period = 12, std_dev_period = 12, std_dev_smoothing_period = 3)
...
@testitem "MIMO - TTM" begin
    ...
    ind = TTM(period = 20, bb_std_dev_mult = 2.0, kc_atr_mult = 2.0)
...
@testitem "MIMO - PivotsHL" begin
    ...
    ind = PivotsHL(high_period = 7, low_period = 7, memory = 10)
    @test nobs(ind) == 0
