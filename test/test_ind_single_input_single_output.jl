@testset "single input - single output" begin  # take only a single value as input
    ...
    @testset "SMMA" begin
        @testset "last 3 values" begin
            ...
            fit!(ind, CLOSE_TMPL)
            @test ind.rolling
            @test isapprox(ind[end-2], 9.149589; atol = ATOL)
            @test isapprox(ind[end-1], 9.203610; atol = ATOL)
    ...
    @testset "RSI" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 57.880437; atol = ATOL)
        @test isapprox(ind[end-1], 55.153392; atol = ATOL)
    ...
    @testset "MeanDev" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 0.608949; atol = ATOL)
        @test isapprox(ind[end-1], 0.595400; atol = ATOL)
    ...
    @testset "StdDev" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 0.800377; atol = ATOL)
        @test isapprox(ind[end-1], 0.803828; atol = ATOL)
    ...
    @testset "ROC" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 30.740740; atol = ATOL)
        @test isapprox(ind[end-1], 26.608910; atol = ATOL)
    ...
    @testset "WMA" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 9.417523; atol = ATOL)
        @test isapprox(ind[end-1], 9.527476; atol = ATOL)
    ...
    @testset "HMA" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 9.718018; atol = ATOL)
        @test isapprox(ind[end-1], 9.940188; atol = ATOL)
    ...
    @testset "DPO" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 0.344499; atol = ATOL)
        @test isapprox(ind[end-1], 0.116999; atol = ATOL)
    ...
    @testset "CoppockCurve" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 27.309482; atol = ATOL)
        @test isapprox(ind[end-1], 26.109333; atol = ATOL)
    ...
    @testset "ALMA" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 9.795859; atol = ATOL)
        @test isapprox(ind[end-1], 10.121439; atol = ATOL)
    ...
    @testset_skip "DEMA (buggy - help wanted)" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 9.683254; atol = ATOL)
        @test isapprox(ind[end-1], 9.813792; atol = ATOL)
    ...
    @testset_skip "KAMA (buggy - help wanted)" begin
        ...
        ind = Memory(ind, n = 3)
        fit!(ind, CLOSE_TMPL)
        @test isapprox(ind[end-2], 8.884374; atol = ATOL)
        @test isapprox(ind[end-1], 8.932091; atol = ATOL)
