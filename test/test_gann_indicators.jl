...
using OnlineTechnicalIndicators: 
    GannSwingChart, GannSwingChartVal,
    PeakValleyDetector, PeakValleyVal,
    RetracementCalculator, RetracementVal, 
    SupportResistanceLevel, SupportResistanceLevelVal
using Test

@testset "Gann Swing Indicators Tests" begin
    
    @testset "GannSwingChart" begin
    ...
    @testset "PeakValleyDetector" begin
        # Test construction
    ...
    @testset "RetracementCalculator" begin
        # Test construction
    ...
    @testset "SupportResistanceLevel" begin
        # Test construction
    ...
    @testset "Integration Test - Multiple Indicators" begin
