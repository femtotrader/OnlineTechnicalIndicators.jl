...
SMA(x::AbstractArray, args...; kwargs...) =
    apply_func(x, SMA, args...; kwargs...)

EMA(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.EMA, args...; kwargs...)

SMMA(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.SMMA, args...; kwargs...)

RSI(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.RSI, args...; kwargs...)
...
VTX(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.VTX, args...; kwargs...)
...
Aroon(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.Aroon, args...; kwargs...)
...
SFX(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.SFX, args...; kwargs...)

TTM(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.TTM, args...; kwargs...)
...
STC(x::AbstractArray, args...; kwargs...) =
    apply_func(x, IncTA.STC, args...; kwargs...)
