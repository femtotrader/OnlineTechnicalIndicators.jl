...
| `BOP` | Balance Of Power | :candle: |  | :heavy_check_mark:
...
| `TSI` | True Strength Inde |  |  | :construction: This indicator needs indicator chaining to be implemented which is currently not done
